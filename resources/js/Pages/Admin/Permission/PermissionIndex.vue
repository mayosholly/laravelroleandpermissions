                ...
                <template #default>
                    <TableRow v-for="permission in permissions" :key="permission.id" class="border-b">
                        ...
                        <TableDataCell class="space-x-4">
                            <Link :href="route('permissions.edit', permission)" class="text-green-400 hover:text-green-600">Edit</Link>
                            <Link :href="route('permissions.destroy', permission)" method="DELETE" as="button" class="text-red-400 hover:text-red-600">Delete</Link>
                        </TableDataCell>
                    </TableRow>
                </template>
              </Table>
